...
export function buildOpenAIUsageDisplay(
    ...
    if (primaryWindow !== null && primaryWindow !== undefined) {
    ...
    if (secondaryWindow !== null && secondaryWindow !== undefined) {
        metrics.push(usageWindowMetric('Weekly', secondaryWindow, 'used_percent', now, {
            vendor: Vendors.OPENAI,
        }));
    }
